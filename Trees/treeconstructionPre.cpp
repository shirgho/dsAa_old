...
written by rathbhupendra. 

Is good. But why not use Node constructor instead of seperate helper function?

Will select first value in pre array as root. Increment Index here for next call.
Then find the value in inArray and split into two ranges, left and right tree
Recursively call to create left tree from above two steps, then right tree.
